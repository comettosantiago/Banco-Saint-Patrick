    ...
    <div className='container'>
      ...
      {showKeyboard && 
        <div className='buttons-keyboard grid grid-cols-3 gap-4 w-48'>
          <div><PasswordButton onClick={handleClickButton} label="1" value="1"/></div>
          <div><PasswordButton onClick={handleClickButton} label="2" value="2"/></div>
          <div><PasswordButton onClick={handleClickButton} label="3" value="3"/></div>
          <div><PasswordButton onClick={handleClickButton} label="4" value="4"/></div>
          <div><PasswordButton onClick={handleClickButton} label="5" value="5"/></div>
          <div><PasswordButton onClick={handleClickButton} label="6" value="6"/></div>
          <div><PasswordButton onClick={handleClickButton} label="7" value="7"/></div>
          <div><PasswordButton onClick={handleClickButton} label="8" value="8"/></div>
          <div><PasswordButton onClick={handleClickButton} label="9" value="9"/></div>
          <div></div>
          <div><PasswordButton onClick={handleClickButton} label="0" value="0"/></div>
